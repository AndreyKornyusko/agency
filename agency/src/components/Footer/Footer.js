  ...
  <footer className={styles.footer}>
    <header className={styles.footerHeader}>
      <div className={styles.container}>
        <a href='#'>
          <div className={styles.logo}> Amazing Agency
            {/* <Logo name='icon-logo' iconClass={styles.logo} logoLink={styles.logoLink} /> */} </div>
        </a>
        <Navigation
          items={navItems}
    ...
    <footer className={styles.footerFooter}>
      <div className={styles.container}>
        ...
        <div className={styles.copywrite}>
          <a href='#'><span className={styles.copywriteText}>© amazing.agency specially for the test task</span></a>
        </div>
      </div>
    </footer>
  </footer>
